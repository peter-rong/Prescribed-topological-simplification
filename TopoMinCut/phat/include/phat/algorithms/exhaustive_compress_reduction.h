	...
	template <typename Representation>
	    ...
	    std::vector<bool> negative(nr_columns,false);
	        ...
	        // Compress
                ...
                //TODO this line and lines above are shown to be destructive to the results
                ...
                while (lowest_one != -1) {
                    if (lowest_one_lookup[lowest_one] != -1) {
                        ...
                        if (!is_pivot) {
                            ...
                            //modify this to become standard reduction
                            //check if the result matches with the standard_reduction result
                        }
